...
import {
    ...
    FiCheck, FiCheckCircle, FiCloud, FiDownload, FiExternalLink, FiFilm,
    FiHome, FiLock,
    FiLogIn,
    FiLogOut, FiMenu, FiMoon, FiPlus, FiRefreshCw, FiSearch, FiStar, FiSun,
    FiX,
} from "react-icons/fi"
...
export function AppIcon(props: BoxProps) {
    return (
        <Box {...props} asChild>
            <NextImage src="/icon.png" alt="make-movies" width={40} height={40} unoptimized />
        </Box>
    )
}

export function AppName() {
    return <Text ml={1}><b>MAKE</b> Movies</Text>
}
